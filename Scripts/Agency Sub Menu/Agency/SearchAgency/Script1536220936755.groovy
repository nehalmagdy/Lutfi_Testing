...
for (def index : (0..data.getRowNumbers() - 1)) {
	...
	WebUI.clickOffset(findTestObject('AgencyControlPage/SearchCard/txt_From'),0,0)
	
	if(from.equals("")){
		WebUI.sendKeys(findTestObject('AgencyControlPage/SearchCard/txt_From'), Keys.chord('f', Keys.BACK_SPACE))
		WebUI.sendKeys(findTestObject('AgencyControlPage/SearchCard/txt_From'), Keys.chord('f', Keys.ARROW_RIGHT))
		WebUI.sendKeys(findTestObject('AgencyControlPage/SearchCard/txt_From'), Keys.chord('f', Keys.BACK_SPACE))
		WebUI.sendKeys(findTestObject('AgencyControlPage/SearchCard/txt_From'), Keys.chord('f', Keys.ARROW_RIGHT))
		WebUI.sendKeys(findTestObject('AgencyControlPage/SearchCard/txt_From'), Keys.chord('f', Keys.BACK_SPACE))
		//WebUI.sendKeys(findTestObject('AgencyControlPage/SearchCard/txt_From'), Keys.chord('f', Keys.ARROW_RIGHT))
	...
	WebUI.sendKeys(findTestObject('AgencyControlPage/SearchCard/txt_From'), from.replaceAll("/", ""))
	}
   
	 WebUI.clickOffset(findTestObject('AgencyControlPage/SearchCard/txt_To'),0,0)
	
	 if(to.equals("")){
		WebUI.sendKeys(findTestObject('AgencyControlPage/SearchCard/txt_To'), Keys.chord('f', Keys.BACK_SPACE))
		WebUI.sendKeys(findTestObject('AgencyControlPage/SearchCard/txt_To'), Keys.chord('f', Keys.ARROW_RIGHT))
		WebUI.sendKeys(findTestObject('AgencyControlPage/SearchCard/txt_To'), Keys.chord('f', Keys.BACK_SPACE))
		WebUI.sendKeys(findTestObject('AgencyControlPage/SearchCard/txt_To'), Keys.chord('f', Keys.ARROW_RIGHT))
		WebUI.sendKeys(findTestObject('AgencyControlPage/SearchCard/txt_To'), Keys.chord('f', Keys.BACK_SPACE))
	}
	else{
		WebUI.sendKeys(findTestObject('AgencyControlPage/SearchCard/txt_To'), to.replaceAll("/", ""))
	}
	
	WebUI.setText(findTestObject('AgencyControlPage/SearchCard/txt_mobile'), mobile)
	WebUI.setText(findTestObject('AgencyControlPage/SearchCard/txt_comission'), comission)
	WebUI.setText(findTestObject('AgencyControlPage/SearchCard/txt_Name'), name)

    WebUI.click(findTestObject('AgencyControlPage/SearchCard/btn_Search'))
	...
	String EmptyGrid = WebUI.getText(findTestObject("AgencyControlPage/EmptyGridTD"))
	if(EmptyGrid.equals("No data available in table") && count==0){
		//pass
	}
